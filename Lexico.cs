...
namespace Evalua
{
    public class Lexico : Token
    {
        ...
        {
            linea = 1;
            string path = "C:\\Users\\HOME\\Documents\\PAOLA TAREAS\\5TO SEMESTRE\\AUTOMATAS II\\UNIDAD 1\\Evalua\\prueba.cpp";
            bool existencia = File.Exists(path);
            log = new StreamWriter("C:\\Users\\HOME\\Documents\\PAOLA TAREAS\\5TO SEMESTRE\\AUTOMATAS II\\UNIDAD 1\\Evalua\\prueba.Log"); 
            log.AutoFlush = true;
            ...
            if (existencia == true)
            {
                archivo = new StreamReader("C:\\Users\\HOME\\Documents\\PAOLA TAREAS\\5TO SEMESTRE\\AUTOMATAS II\\UNIDAD 1\\Evalua\\prueba.cpp");
            }
            else
            {
